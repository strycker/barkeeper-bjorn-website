...
The keys live in `.claude/settings.json` (project) or `/Users/glestryc/personal/github_repos/barkeeper-bjorn-website/.claude/settings.json` (global) — **not** in `.planning/config.json`:
