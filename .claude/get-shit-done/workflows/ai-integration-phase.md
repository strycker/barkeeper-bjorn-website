...
<required_reading>
@/Users/glestryc/personal/github_repos/barkeeper-bjorn-website/.claude/get-shit-done/references/ai-frameworks.md
@/Users/glestryc/personal/github_repos/barkeeper-bjorn-website/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/glestryc/personal/github_repos/barkeeper-bjorn-website/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/glestryc/personal/github_repos/barkeeper-bjorn-website/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/glestryc/personal/github_repos/barkeeper-bjorn-website/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/glestryc/personal/github_repos/barkeeper-bjorn-website/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/glestryc/personal/github_repos/barkeeper-bjorn-website/.claude/agents/gsd-eval-planner.md for instructions.
