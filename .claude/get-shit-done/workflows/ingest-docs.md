...
```bash
INIT=$(node "/Users/glestryc/personal/github_repos/barkeeper-bjorn-website/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/glestryc/personal/github_repos/barkeeper-bjorn-website/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
