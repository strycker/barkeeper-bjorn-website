...
```
Task(
  prompt="Read /Users/glestryc/personal/github_repos/barkeeper-bjorn-website/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/glestryc/personal/github_repos/barkeeper-bjorn-website/.claude/get-shit-done/templates/SECURITY.md`
