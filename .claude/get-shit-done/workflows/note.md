...
- **Global scope**: `/Users/glestryc/personal/github_repos/barkeeper-bjorn-website/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/glestryc/personal/github_repos/barkeeper-bjorn-website/.claude/notes/`)
...
2. Glob `/Users/glestryc/personal/github_repos/barkeeper-bjorn-website/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/glestryc/personal/github_repos/barkeeper-bjorn-website/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/glestryc/personal/github_repos/barkeeper-bjorn-website/.claude/notes/` — works in any directory
