...
- Usage: Reference from command with `@/Users/glestryc/personal/github_repos/barkeeper-bjorn-website/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/glestryc/personal/github_repos/barkeeper-bjorn-website/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/glestryc/personal/github_repos/barkeeper-bjorn-website/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
