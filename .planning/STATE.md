...
| 6 | Recipe & Recommender UX | In Progress | REC-10+11 shipped; 06-01–06-03 pending | 20% |
...
*Last activity: 2026-05-19 — Phase 5 UAT complete (17/17 pass). Phase 6 opened: REC-10 (card layout fix) and REC-11 (heart/star toggle state) shipped as bugfixes. ROADMAP renumbered to 10 phases with new Phase 6 (Recipe & Recommender UX). 168-recipe DB added (classics-db-extra-1.js + extra-2.js). Favicon added. Archetype selection fixed (no cap, text entry, custom archetypes merged).*
